    ...
    <div class="row">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li>
                            <a href="{{ url('task/needstop') }}">
                                ...
                                <small class="label pull-right bg-green" style="margin-top: 3px;">{{ $needstop }}</small>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="col-md-9">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">修改后的任务
                        <small>下列任务已由运营人员修改过，请按照新的计划执行</small>
                    </h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body no-padding">
