                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif($item->status == 2)
                                        ...
                                        <span class="label label-info" style="font-size: 0.9em;">待配置</span>
                                ...
                                <td style="width: 240px; text-align: center">
                                    ...
                                    <a href="{{ url('business/toconfig/' . $item->id) }}" type="button" class="btn btn-default">
